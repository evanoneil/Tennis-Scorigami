...
datatable(top_winners,
  ...
  formatRound(columns = c("avg_rank"), digits = 1)
```
...
* Jannik Sinner was very good at tennis in 2024
...
5. Bringing in court speed to see variation within the three surface areas
